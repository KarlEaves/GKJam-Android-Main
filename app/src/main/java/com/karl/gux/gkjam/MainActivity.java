...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop_button = findViewById(R.id.stop_recording_button);
    ...
    {
        Button start_button = findViewById(R.id.start_recording_button);
            ...
            public void onClick(View v){
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run()
                        {
                            ...
                            //===========SET TEXT OF PITCH======================
                            final TextView pitchText = findViewById(R.id.frequency);
